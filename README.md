...
## IN vs code or pycharm run this code to setup and run the command : 
```
conda create -n wafer1  python=3.7 -y
$pip install -r requirements.txt
$python main.py
#see whether our branch is main or master by typing this code : $git branch
$conda env list #to list the environment and wherever '*' symbol you see it mean that environment is activated
```
